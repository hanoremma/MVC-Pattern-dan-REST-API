...
namespace PerpustakaanAppMVC.Controller
{
    public class MahasiswaController
    {
        ...
        public int Create(Mahasiswa mhs)
        {
            ...
            {
                MessageBox.Show("Data mahasiswa gagal disimpan !", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        ...
        public int Update(Mahasiswa mhs)
        {
            ...
            {
                MessageBox.Show("Data mahasiswa gagal diupdate !", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        ...
        public int Delete(Mahasiswa mhs)
        {
            ...
            {
                MessageBox.Show("Data mahasiswa gagal dihapus !", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
